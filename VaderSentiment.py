...
BJP = pd.read_csv("procBJPtweets.csv",names=['tweet'])
INC = pd.read_csv("procINCtweets.csv",names=['tweet'])
...
print(BJP.head(10))
print(INC.head(10))
INC.to_csv("INC_Labelled.csv",index=False)
BJP.to_csv("BJP_Labelled.csv",index=False)
