...
test = pd.read_csv('procINCtweets.csv',names=['tweet'])
...
combined_set.to_csv("Combined_preprocessed_tweets.csv",index=False)
ProcessedTrain = combined_set.iloc[:60001,:]
ProcessedTest = combined_set.iloc[60000:,:]
#13933
ProcessedTest.to_csv("ProcessedTest.csv",index=False)
ProcessedTrain.to_csv("ProcessedTrain.csv",index=False)
